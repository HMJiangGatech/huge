...
hugeglasso <- function(S, W, T, d, ilambda) {
    .Call(`_huge_hugeglasso`, S, W, T, d, ilambda)
}

hugeglassoscr <- function(S, W, T, d, ilambda) {
    .Call(`_huge_hugeglassoscr`, S, W, T, d, ilambda)
}
