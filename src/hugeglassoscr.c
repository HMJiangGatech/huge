...
void hugeglassoscr(double *S, double *W, double *T, int *dd, double *lambda, int *df)
{
    ...
    int *idx_i = (int*) malloc((d2)*sizeof(int)); //The set possibly can join active set
